...
public class RestAPI {
    ...
    public JSONObject CreateNewAccount(String NAME, String PHONE_NO, String EMAIL, String ADDRESS, String PINCODE, String PICKUPDATE, String PICKUPTIME) throws Exception {
        ...
        p.put("PHONE_NO", mapObject(PHONE_NO));
        p.put("EMAIL", mapObject(EMAIL));
        p.put("ADDRESS", mapObject(ADDRESS));
        p.put("PINCODE", mapObject(PINCODE));
        p.put("PICKUPDATE", mapObject(PICKUPDATE));
        p.put("PICKUPTIME", mapObject(PICKUPTIME));
        o.put("parameters", p);
        String s = o.toString();
        String r = load(s);
